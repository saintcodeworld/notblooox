      ...
      <div className="flex justify-between items-center">
        <div className="shadow-4xl p-4 rounded-lg space-y-1 bg-gray-800 bg-opacity-20">
          ...
          <a
            ...
            href="/"
          >
            Blox<span className="font-medium">.online</span>
          </a>
          <div className="text-sm flex justify-center text-white">
            <div className="flex items-center justify-center mt-2 gap-2 px-3 py-1 w-full bg-transparent border border-b-2 rounded-md">
              <svg
